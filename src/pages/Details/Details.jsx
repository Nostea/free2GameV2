...
import { Recently, SearchedGames, UserInput, AllGamesFetch } from "../../components/Context/Context";
...
const Details = () => {
    ...
    const baseUrl = "https://free-to-play-games-database.p.rapidapi.com/api/game?";
    const options = {
        method: "GET",
        headers: {
